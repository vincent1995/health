...
if __name__=="__main__":
    ...
    import glob
    for f in glob.glob(r'C:\Users\vincent\OneDrive\online\python\project\preprocess\test_pic\*'):
        img = Image.open(f)
        s = to_pil(stretch(from_pil(img)))
        r = to_pil(retinex_adjust(retinex(from_pil(img))))
        image_merge((img,s,r)).show()
        ...
        # print("standard_deviation_weighted_grey_world")
        # dlib.hit_enter_to_continue()
